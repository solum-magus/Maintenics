...
<body>
    ...
    <div class="header-flex">
        <img src="Assets/Logo.png" alt="SMART Logo" class="Logo">
        <h1>SMART</h1>
    </div>
    <div class="content">
    ...
    <img src="Assets/stuff1.svg" class="img-fluid" id="stuff" style="max-width: 80%; height: 100%; right: 10%;  top: 3%; z-index: -1;">
</div>
