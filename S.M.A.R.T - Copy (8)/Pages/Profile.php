<?php
    ...
    if (isset($_SESSION["fname"]) && isset($_SESSION["position"]) && isset($_SESSION["id"])) {
    ...
    <div class="d-flex">
        ...
        <div class="flex" id="main1">
                    <div class="col-2" id="profile">
                        <img src="../Assets/profile.svg" style="width: 150px; height: 150px; margin: 10px;" >
                    </div>
        ...
        <?php if (($position) === "Admin"):  ?>
            ...
            <div class="row" id="main2">
                ...
                <a href="Manage.php"><img src="../Assets/logo.svg">
                <p>User Management</p>
                </a>
                </div>

                <div class="col-4 d-flex">
                <a href="Approval.php"><img src="../Assets/logo.svg">
                <p>Role Approval</p>
                </a>
                </div>
