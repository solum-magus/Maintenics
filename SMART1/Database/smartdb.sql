...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 01, 2025 at 02:21 PM
...
(1073, NULL, NULL, '', 0, 'Ampi', 'Broken Chair', 'sd', '', 0, 'Pending', '2025-03-27 06:29:54', NULL, 1),
(1074, NULL, NULL, '', 0, 'Room 101', 'Broken Chair', 'sd', '', 0, 'Pending', '2025-03-27 06:32:40', NULL, 1),
...
(1078, NULL, NULL, 'Leiby Rose Masanegra', 33333333333, 'Ampi', 'No Wi-Fi', '', '', 0, 'Resolved', '2025-04-01 09:38:23', NULL, 1);
...
('Admin', 'Zanjoe Junel Soliveres', 11111111111, '$2y$10$Bo6aj7R8YzazHLB1k4ljE.LOCMXmV1PdzbRyB.Mx.0hlbijCEuKq.', '', 1, 'Approved'),
...
('Maintenance Staff', 'Stephen Chase Nepomuceno', 100000000000, '$2y$10$6RI8kpmwl5TbBX3EVTtYAurDRi0hHkXLW1hzHnrQP37UfqCXL2Qh6', '', 1, 'Approved'),
...
--
ALTER TABLE `reportdetails`
  MODIFY `report_id` bigint(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1079;
COMMIT;
