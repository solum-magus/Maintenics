...
<h2><b>Edit User</b></h2>
        <form action="../Authentication/Admin/edit.php" method="post">
            <input type="hidden" name="original_school_id" value="<?= htmlspecialchars($user['school_id']) ?>">

            <div class="mb-3">
                <label for="full_name" class="form-label">School Email</label> <br>
                <input type="text" name="new_school_id" class="form-control"
