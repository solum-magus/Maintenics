    ...
    /*elseif (!ctype_digit($school_id) || strlen($school_id) < 11 || strlen($school_id) > 12) {
        ...
        if ($result_check_id->num_rows > 0) {
            ...
            if ($result_check_name->num_rows > 0) {
                ...
                $userstatus = ($position === 'Maintenance Staff' || $position === 'Admin' || $position === 'Student' || $position === 'Teacher') ? "Pending" : "Approved";
                ...
                try {
                    ...
                    echo "<script>
                          document.addEventListener('DOMContentLoaded', function() {
                              customAlert('An error occurred while creating the account.');
                          });
                          setTimeout(function() {
                              window.location.href = 'index.php';
                          }, 2000);
        ...
        <div class="wrapper px-4 <?php echo (!empty($error_message2) || isset($_GET['signup_success'])) ? 'active' : ''; ?>" style="max-width: 400px; width: 100%;">
            ...
            <div class="form-group">
                <input type="text" id="school_id" name="school_id" required
                  ...
                  pattern="^[a-zA-Z]+\.[0-9]+@meycauayan\.sti\.edu\.ph$"
            ...
            <form action="Authentication/signin.php" method="post" id="signInForm">
                <div class="mb-3">
                <label for="signin_full_name" class="form-label">School Email</label>
                <input type="text" id="signin_full_name" name="signin_full_name" maxlength="70" required
                    class="form-control"
                    onblur="this.value = this.value.trim()" placeholder="Enter your school email"
