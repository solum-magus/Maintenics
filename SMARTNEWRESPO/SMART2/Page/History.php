...
<?php if (!empty($reports)): ?>
                ...
                <?php if ($position != "Maintenance Staff" && empty($report['feedback'])) : ?>
                    <div class="feedback-form">
                        <form method="POST" action="../Authentication/sendfeedback.php">
                            ...
                            <textarea name="feedback" id="textarea" placeholder="Leave your feedback here..." rows="4"></textarea>
    ...
    <?php endforeach; ?>
<?php else: ?>
    <p class="feedback-submitted"><b>Feedback: <?= !empty($report['feedback']) ? htmlspecialchars($report['feedback']) : 'No feedback given.' ?></p>
<?php endif; ?>
