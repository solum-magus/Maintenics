    ...
    <div class="company-info">
        ...
        <div id="passwordModal" class="modal">
            <div class="modal-content">
                ...
                <form action="../Authentication/change_pass.php" method="POST">
                    <label for="school_id">School Email:</label>
        ...
        <div id="privacyModal" class="modal">
            <div class="modal-content">
                ...
                <br>
                <ul>
                    <li><strong>Personal Information</strong> – Name, email address, school email, and position (Student, Teacher, Maintenance Staff, Admin).</li>
                    <br>
