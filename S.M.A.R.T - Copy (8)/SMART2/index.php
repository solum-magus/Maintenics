    ...
    if (empty($error_message)) {
        ...
        try {
            ...
            if ($position === 'Maintenance Staff' || $position === 'Admin') {
                echo "<script>window.location.href='Page/AdminHome.php';</script>";
            } else {
...
<body>
    ...
    <div class="content">
        ...
        <div class="col-6 d-flex justify-content-center align-items-center" style="height: 100vh; width: 100vh;">
            <img src="Assets/stuff1.svg" class="img-fluid" id="stuff" style="max-width: 80%; height: 100%; right: 10%;  top: 2%; z-index: -1;">
        </div>
        </div>
    </div>
