...
<div class="form-container">
    ...
    <form id="reportForm">
        <input type="hidden" id="rname" name="rname" value="<?= htmlspecialchars($_SESSION['fname']) ?>">
        <input type="hidden" id="rid" name="rid" value="<?= htmlspecialchars($_SESSION['id']) ?>">
        ...
        <textarea id="pdescription" placeholder="Description (required)" required></textarea>
